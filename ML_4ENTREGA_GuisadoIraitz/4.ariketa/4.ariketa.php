...
<body>
    ...
    // bilaketa hutsik ez badago, bilaketaren parametroak gehitzen dira kontsultara
    if (!empty($bilatu)) {
    ...
    <form action="4.ariketa.php" method="post">
        <!-- bilaketaren parametroak ezartzeko formularioa -->
        ...
        <select id="mota" name="mota">
            <option value="" <?php if ($motaFiltratu == '')
                echo 'selected'; ?>>Guztiak</option>
            <option value="Elikagaia" <?php if ($motaFiltratu == 'Elikagaia')
                echo 'selected'; ?>>Elikagaia</option>
            <option value="Edaria" <?php if ($motaFiltratu == 'Edaria')
                echo 'selected'; ?>>Edaria</option>
            <option value="Fruta" <?php if ($motaFiltratu == 'Fruta')
                echo 'selected'; ?>>Fruta</option>
            <option value="Gozoa" <?php if ($motaFiltratu == 'Gozoa')
                echo 'selected'; ?>>Gozoa</option>
            <option value="Espeziak" <?php if ($motaFiltratu == 'Espeziak')
                echo 'selected'; ?>>Espeziak</option>
            <option value="Barazkia" <?php if ($motaFiltratu == 'Barazkia')
                echo 'selected'; ?>>Barazkia</option>
            <option value="Haragia" <?php if ($motaFiltratu == 'Haragia')
                echo 'selected'; ?>>Haragia</option>
            <option value="Itsaskia" <?php if ($motaFiltratu == 'Itsaskia')
